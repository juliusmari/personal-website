...
const SocialLinks = () => {
	...
	const sideLinks = [
		...
		},
		{
			...
			href:
				'https://mail.google.com/mail/u/0/#inbox?compose=CllgCJTJFPCTmlFXCtCtSrjSlcLqnTjfKqpSCvXjHWFbnjxzdcmWmndLDNbqDBfQpzpBhgRKnNV',
			style: '',
		},
		{
			id: 4,
				...
				<ul className=''>
					{sideLinks.map(({ id, child, href, style }) => (
						<li
							key={id}
							className={
								'flex justify-between text-colorBlack font-semibold items-center w-40 h-14 px-4 ml-[-100px] hover:ml-[-10px] hover:rounded-md duration-300 hover:text-colorPurple' +
								' ' +
								style
							}
						>
