  ...
  function portfolioData() {
    return (
      <div
        id="collaboration"
        ref={ref}
        className="max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-fit md:h-full"
      >
            ...
            >
              ...
              <div className="flex items-center justify-center">
                <a href={link} target="_blank" rel="noreferrer">
                  <button className="px-5 py-2 m-4 duration-200 border-2 font-semibold  border-colorPurple hover:text-white  rounded-xl">
                    Visit Website
                  </button>
                </a>
              </div>
